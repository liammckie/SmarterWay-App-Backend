                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-select" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $data=mysqli_query($conn,"select * from `clientcheckoutlog` WHERE checkIdID = '".$ClientData."' ORDER BY checkoutId DESC");
                                                                    $counter = 0;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php if($row[2] != NULL){ echo "<a target='_blank' href='checkoutphoto?checkoutId=".$row[0]."' style='color:#4680ff;'>View Cleaning Place Photo</a>"; } ?></td>
