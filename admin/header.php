                        ...
                        <ul class="nav-right">
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                	<?php 
                            		$data=mysqli_query($conn,"select * from `Clients` where Id = '".$AdminData."' LIMIT 1");
                                    ...
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        if($row[3] != NULL){
                                        ?>
                                        <img class="user-img img-radius" src="../wp-content/uploads/wpfiles/profile/<?php  echo $row[3]; ?>" style="width:40px; height:40px;">                                                                    </a>
                                        <?php
                                        }
                                        else{
                                        ?>
                            ...
                            <div class="">
                                <div class="main-menu-header">
                                    <?php
                                        if($row[3] != NULL){
                                        ?>
                                        <img class="user-img img-radius" src="../wp-content/uploads/wpfiles/profile/<?php  echo $row[3]; ?>" style="width:65px; height:65px; border:1px solid #808080;">                                                                    </a>
                                        <?php
                                        }
                                        else{
                                        ?>
