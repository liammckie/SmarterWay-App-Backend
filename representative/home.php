      <?php
                         ...
                         //Getting total clients
                                            $data=mysqli_query($conn,"SELECT * FROM `gsheet_master_proposal`");
                                            $clients = 0;
                                            while($row=mysqli_fetch_array($data))
                                            {
                                                $clients++;
                        ...
                        //Getting total porposals                    
                                            $data=mysqli_query($conn,"SELECT * FROM `proposal`");
                                            $porposal = 0;
                                            while($row=mysqli_fetch_array($data))
                                            {
                                                $porposal++;
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong> <?php echo $counter; ?> </strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $porposal; ?></strong></h5>
                      <span>Total Porposals</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left bg-primary fa fa-id-card user1 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo $clients; ?></strong></h5>
