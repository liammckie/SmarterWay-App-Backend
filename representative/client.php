                    ...
                    <div class="col-md-12 chart-layer1-right"> 
					    <div class="user-marorm">
					        <?php 
                                ...
                                $sql = "SELECT * FROM `gsheet_master_proposal` where ClientID=".$_GET['Id'];
					        ...
					        <div class="malorm-bottom">
    							...
    							<p><?php echo $row['Follow Up Notes']; ?></p>
    						</div>
				        </div>
				    </div>
                            ...
                            <div class="profile-card">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-sm-12">
                                            <hr/>
                                            <h3 style="margin-left:15px;font-size:1.2em;color:#337ab7;font-weight:600;">About</h3>
                                            <hr/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <span><?php echo $row['ClientID']; ?></span>
                                        <hr/>
                                        </div>
                                        <div class="col-sm-12">
                                            <span>Email</span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <span>Status</span>
                                            <span style="margin:5%;">:</span>
                                            <span><?php echo $row['Current Status']; ?></span>
                                        <hr/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="col-sm-12">
                                            <span>Address</span>
                                            <span style="margin:5%;">:</span>
                                            <span><?php echo $row['Location Address'].", ".$row['Suburb'].", ".$row['State Full'].", ".$row['Post Code']; ?></span>
                                        <hr/>
                                        </div>
                                    </div>
                                    <hr/>
